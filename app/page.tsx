    ...
    <main className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-red-50">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-30">
          <div className="absolute top-0 left-0 w-96 h-96 bg-gradient-to-br from-orange-200 to-red-200 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute bottom-0 right-0 w-80 h-80 bg-gradient-to-br from-amber-200 to-yellow-200 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute top-1/2 left-1/3 w-64 h-64 bg-gradient-to-br from-red-200 to-pink-200 rounded-full blur-2xl animate-pulse"></div>
        </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="text-center lg:text-left space-y-10">
                ...
                <div className="space-y-6 animate-fade-in-up">
                  <h1 className="text-7xl md:text-9xl font-serif font-bold text-amber-900 leading-none">
                    Tu casa
                  </h1>
                  <h2 className="text-3xl md:text-5xl font-light text-orange-700 italic -mt-4">
                    restaurantes
                  </h2>
                </div>
                ...
                <div className="relative animate-fade-in-up">
                  <p className="text-2xl md:text-3xl text-gray-700 font-light leading-relaxed">
                    <span className="text-amber-600 font-serif italic text-4xl">"</span>
                    El buen sabor, hecho con amor
                    <span className="text-amber-600 font-serif italic text-4xl">"</span>
                  </p>
                  <div className="absolute -bottom-2 left-1/2 lg:left-0 transform -translate-x-1/2 lg:translate-x-0 w-24 h-1 bg-gradient-to-r from-amber-500 to-orange-500 rounded-full"></div>
                </div>

                {/* Organic action buttons */}
                <div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start items-center pt-8 animate-fade-in-up">
                  <a
                    href="https://menu.tucasarestaurantes.com/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group relative bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white px-12 py-6 rounded-full text-lg font-medium transition-all duration-300 transform hover:scale-105 organic-shadow hover:organic-shadow-lg min-w-[280px]"
                  >
                  ...
                  <div className="flex gap-4">
                    ...
                    <button className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-6 rounded-full text-lg font-medium transition-all duration-300 transform hover:scale-105 organic-shadow hover:organic-shadow-lg">
                      <span className="flex items-center gap-2">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="relative animate-fade-in-up">
                <div className="relative group">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-amber-300/20 to-orange-300/20 rounded-3xl blur-2xl transform rotate-3 group-hover:rotate-6 transition-transform duration-500"></div>
                  ...
                  <div className="relative bg-white rounded-3xl p-6 organic-shadow-lg transform -rotate-2 group-hover:rotate-0 transition-transform duration-500">
                    ...
                    <div className="absolute -top-4 -right-4 bg-amber-500 text-white px-6 py-3 rounded-full font-semibold text-sm organic-shadow transform rotate-12 animate-bounce flex items-center gap-2">
                    ...
                    <div className="absolute -bottom-3 -left-3 bg-green-500 text-white px-4 py-2 rounded-full font-medium text-xs organic-shadow transform -rotate-12 animate-pulse flex items-center gap-2">
        ...
        <div className="container mx-auto px-6 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-16 animate-fade-in-up">
              <h3 className="text-5xl md:text-6xl font-serif font-bold text-amber-900 mb-6">
                ¿Listo para disfrutar?
              </h3>
              <p className="text-xl text-gray-700 leading-relaxed max-w-2xl mx-auto">
                Nuestro equipo está esperando para prepararte una experiencia culinaria inolvidable.
                <span className="text-amber-600 font-semibold block mt-2">¡Contáctanos ahora!</span>
              </p>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-8 justify-center items-center animate-fade-in-up">
              <a
                ...
                className="group relative bg-white hover:bg-amber-50 text-gray-800 px-10 py-8 rounded-2xl transition-all duration-300 transform hover:scale-105 organic-shadow hover:organic-shadow-lg min-w-[320px]"
              >
                <div className="flex items-center gap-6">
                  <div className="bg-amber-500 p-4 rounded-full organic-shadow">
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-amber-600 font-bold text-lg">+1 551 482 2835</div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-20 animate-fade-in-up">
              <h3 className="text-5xl font-serif font-bold text-amber-900 mb-6">
                Nuestra promesa
              </h3>
            ...
            <div className="grid md:grid-cols-3 gap-12">
              ...
              <div className="text-center group animate-fade-in-up">
                <div className="relative mb-8">
                  <div className="w-32 h-32 bg-gradient-to-br from-amber-400 to-orange-400 rounded-full mx-auto flex items-center justify-center organic-shadow group-hover:organic-shadow-lg transition-all duration-300">
                  ...
                  <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-16 h-1 bg-amber-500 rounded-full"></div>
                </div>
                <h4 className="text-2xl font-semibold text-amber-900 mb-4">Ingredientes frescos</h4>
              ...
              <div className="text-center group animate-fade-in-up">
                <div className="relative mb-8">
                  <div className="w-32 h-32 bg-gradient-to-br from-green-400 to-emerald-400 rounded-full mx-auto flex items-center justify-center organic-shadow group-hover:organic-shadow-lg transition-all duration-300">
                    <svg className="w-16 h-16 text-white" fill="currentColor" viewBox="0 0 24 24">
                ...
                <h4 className="text-2xl font-semibold text-amber-900 mb-4">Servicio rápido</h4>
                <p className="text-gray-600 leading-relaxed">
              ...
              <div className="text-center group animate-fade-in-up">
                <div className="relative mb-8">
                  <div className="w-32 h-32 bg-gradient-to-br from-red-400 to-pink-400 rounded-full mx-auto flex items-center justify-center organic-shadow group-hover:organic-shadow-lg transition-all duration-300">
                    <svg className="w-16 h-16 text-white" fill="currentColor" viewBox="0 0 24 24">
                ...
                <h4 className="text-2xl font-semibold text-amber-900 mb-4">Preparado con amor</h4>
                <p className="text-gray-600 leading-relaxed">
      ...
      <a
        href="tel:+15514822835"
        className="fixed bottom-28 right-6 w-16 h-16 bg-amber-500 hover:bg-amber-600 text-white rounded-full organic-shadow hover:organic-shadow-lg transition-all duration-300 transform hover:scale-110 flex items-center justify-center z-50"
